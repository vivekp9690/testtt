  ...
  renderProductDetails(data) {
    ...
    return (
          <View>
            ...
            {((Number(this.props.itemDetail.productDetails.length)-1) == index && 
                  <View
                  style={{
                    height: 1,
                    width: "100%",
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView>
            ...
            <View style={[styles.row,styles.listlabelRow]}>
             ...
             <FlatList
              containerStyle={[styles.row,styles.flatcontainer]}
              scrollEnabled={false}
              data={this.props.itemDetail.productDetails}
              extraData={this.state.products}
              showsVerticalScrollIndicator={false}
              renderItem={this.renderProductDetails.bind(this)}
            ...
            <View style={{paddingBottom:10}}>
             <FlatList
              containerStyle={[styles.borderRow,styles.row,styles.rateflatcontainer]}
              scrollEnabled={false}
              ...
              renderItem={({item}) => 
                <View style={styles.rateflatview}>
                  <TouchableOpacity activeOpacity={1} onPress = {() => this.onItemClick(item)}>
                    ...
                    <View style={styles.innerViewDate}>
